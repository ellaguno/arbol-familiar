<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-theme">{{ __('Mi Perfil') }}</h1>
            <p class="text-theme-secondary mt-1">{{ __('Actualiza tu informacion personal') }}</p>
        </div>
                ...
                <div class="card mt-6">
                    <div class="card-body p-0">
                        <nav class="space-y-1">
                            ...
                            <a href="{{ route('profile.settings') }}" class="flex items-center gap-3 px-4 py-3 text-theme-secondary hover:bg-theme-secondary">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
