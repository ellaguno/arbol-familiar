<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">{{ __('Familias') }}</h1>
                <p class="text-gray-600 mt-1">{{ __('Unidades familiares en tu arbol genealogico') }}</p>
            </div>
        ...
        @if($families->isEmpty())
            <div class="card">
                <div class="card-body text-center py-12">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">{{ __('No hay familias') }}</h3>
                    <p class="text-gray-500 mb-4">{{ __('Crea una familia para organizar tu arbol genealogico.') }}</p>
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        @else
                                            <div class="w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center mx-auto">
                                                <span class="text-blue-600 font-bold text-xl">{{ substr($family->husband->first_name, 0, 1) }}</span>
                                            </div>
                                        @endif
                                    ...
                                    <div class="text-center">
                                        ...
                                        @else
                                            <div class="w-16 h-16 rounded-full bg-pink-100 flex items-center justify-center mx-auto">
                                                <span class="text-pink-600 font-bold text-xl">{{ substr($family->wife->first_name, 0, 1) }}</span>
                                            </div>
                                        @endif
                            ...
                            <div class="flex justify-center gap-2 mb-4">
                                ...
                                @if($family->hasEthnicHeritage())
                                    <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-blue-100 text-blue-800">*</span>
                                @endif
                            </div>
                            ...
                            @if($family->children->isNotEmpty())
                                <div class="border-t pt-4 mt-4">
                                    <p class="text-sm text-gray-500 mb-2">{{ __('Hijos') }}: {{ $family->children->count() }}</p>
                                    <div class="flex flex-wrap gap-2">
                                        @foreach($family->children->take(4) as $child)
                                            <div class="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-xs font-medium" title="{{ $child->full_name }}">
                            ...
                            <div class="mt-4 pt-4 border-t flex justify-between">
                                ...
                                <a href="{{ route('families.edit', $family) }}" class="text-gray-500 hover:text-gray-700">
