        ...
        <nav class="flex mb-6" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li class="flex items-center">
                    ...
                    <span class="text-gray-700 font-medium ml-1 md:ml-2">{{ __('Nueva familia') }}</span>
                </li>
            </ol>
        </nav>

        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">{{ __('Nueva familia') }}</h1>
            <p class="text-gray-600 mt-1">{{ __('Crea una nueva unidad familiar') }}</p>
        </div>
