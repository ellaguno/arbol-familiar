                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="mt-2 flex flex-wrap gap-2">
                                        @if($person->gender)
                                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {{ $person->gender === 'M' ? 'bg-blue-100 text-blue-800' : ($person->gender === 'F' ? 'bg-pink-100 text-pink-800' : 'bg-gray-100 text-gray-800') }}">
