<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start gap-4 mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">{{ __('Editar persona') }}</h1>
                <p class="text-gray-600 mt-1">{{ $person->full_name }}</p>
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex flex-col gap-2">
                    <form action="{{ route('persons.photo.update', $person) }}" method="POST" enctype="multipart/form-data" class="flex items-center gap-2">
                        @csrf
                        <input type="file" name="photo" accept="image/*" class="text-sm file:mr-2 file:py-1 file:px-3 file:rounded file:border-0 file:text-sm file:bg-gray-100 file:text-gray-700 hover:file:bg-gray-200">
