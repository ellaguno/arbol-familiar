    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <nav class="flex mb-6" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li class="flex items-center">
                    ...
                    <span class="text-theme-secondary font-medium ml-1 md:ml-2">{{ __('Galeria') }}</span>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div class="flex items-center gap-4">
                ...
                @endif
                <div>
                    <h1 class="text-2xl font-bold text-theme">{{ __('Galeria') }}</h1>
        ...
        @if($media->isEmpty())
            <div class="card">
                <div class="card-body text-center py-12">
                    ...
                    <h3 class="text-lg font-medium text-theme mb-2">{{ __('Sin fotos ni documentos') }}</h3>
                    <p class="text-theme-muted mb-4">{{ __('Agrega fotos y documentos para esta persona.') }}</p>
                    <a href="{{ route('media.create', ['person_id' => $person->id]) }}" class="btn-primary">
