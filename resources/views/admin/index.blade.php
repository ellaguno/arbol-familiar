<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
            ...
            @if(Route::has('admin.social-login.settings'))
            <a href="{{ route('admin.social-login.settings') }}" class="card hover:shadow-md transition-shadow">
                <div class="card-body flex items-center gap-4">
                    <div class="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center">
                        <svg class="w-5 h-5 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        <h3 class="font-semibold text-theme">{{ __('Login Social') }}</h3>
                        <p class="text-sm text-theme-muted">{{ __('Google, Microsoft, Facebook') }}</p>
                    </div>
                </div>
            </a>
            @endif

            @if(Route::has('admin.photo-banner.settings'))
            <a href="{{ route('admin.photo-banner.settings') }}" class="card hover:shadow-md transition-shadow">
                <div class="card-body flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="font-semibold text-theme">{{ __('Cintillo de Fotos') }}</h3>
                        <p class="text-sm text-theme-muted">{{ __('Banner del dashboard') }}</p>
                    </div>
                </div>
            </a>
            @endif
