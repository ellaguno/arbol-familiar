...
namespace Plugin\ReportsAncestors\Controllers;

use App\Http\Controllers\Controller;
use App\Models\Person;
use Illuminate\Http\Request;

class AncestorReportController extends Controller
{
    /**
     * Mostrar reporte de ancestros en HTML.
     */
    public function show(Request $request, Person $person)
    {
        ...
        $plugin = app(\App\Plugins\PluginManager::class)->getLoaded()['reports-ancestors'] ?? null;
    ...
    /**
     * Descargar reporte de ancestros en PDF.
     */
